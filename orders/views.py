...
def login_view(request):
    ...
    if user is not None:
        ...
        return render(request,"login.html",{"message":"Usuario inválido"}) 
...
def signin_view(request):
    if request.method == "POST":
        ...
        if first_name is "" or last_name is "" or username is "" or email is "" or password is "":
            return render(request, "signin.html", {"message": "Datos insuficientes"})
        ...
        return render(request,"login.html",{"message":"Usuario Registrado"}) 
